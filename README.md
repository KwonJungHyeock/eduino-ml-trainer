...
![Eduino AI Lab — 이미지 분류 실시간 추론](docs/images/01-image.png)
...
| 영상 효과(필터) | 색상 추적 | 얼굴 검출 |
|---|---|---|
| ![영상 효과](docs/images/02-filter.png) | ![색상 추적](docs/images/03-colortrack.png) | ![얼굴 검출](docs/images/04-face.png) |

| 뼈대(포즈) 검출 | 객체 탐지 | |
|---|---|---|
| ![뼈대 검출](docs/images/05-skeleton.png) | ![객체 탐지](docs/images/06-detect.png) | |
